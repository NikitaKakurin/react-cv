...
export default function Education() {
  return (
    <div className="w-[50%] overflow-y-auto border-x-[1px] border-black px-[1px] shadow-leftPage">
      <div className="p-4">
        ...
        <p className="pl-4 text-justify">
          2004-2009: Украина, Алчевск, Доннбасский Государственный Технический Университет - Инженер
          электронной техники.
        </p>
